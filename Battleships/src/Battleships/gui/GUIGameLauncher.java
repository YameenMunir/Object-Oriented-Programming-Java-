...
import Battleships.*;
import Battleships.strategies.BasicStrategy;
import Battleships.strategies.BetterStrategy;
import Battleships.strategies.BetterStrategyWithDoubleRunAndSpaceDivision;
...
public class GUIGameLauncher {
    public static AbstractGame createGame() {
        ...
        final ComputerPlayerStrategy strategy1 = new BetterStrategyWithDoubleRunAndSpaceDivision();
        final ComputerPlayerStrategy strategy2 = new BetterStrategyWithDoubleRunAndSpaceDivision();
